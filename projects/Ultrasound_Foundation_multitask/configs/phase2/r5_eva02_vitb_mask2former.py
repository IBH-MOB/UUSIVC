"""R5 — EVA02 ViT-B/14 + Feature2Pyramid + Mask2Former.

EVA02 is a strong ViT pretrain (BEiT-style, trained on IN-21K with CLIP
distillation), often beating DINOv2 on dense-prediction transfer. Patch
14, embed 768. Feature2Pyramid synthesizes the 4-level pyramid for
Mask2Former.

Replaces the originally-planned SAM ViT-B: SAM uses relative position
embeddings (rel_pos_h/w) sized for its native 1024 resolution and
cannot be resized to our 384 crop without custom interpolation. EVA02
uses standard absolute pos_embed which interpolates cleanly.
"""
...
work_dir = '/scratch/dr/o.iraqy/UUSIVC-MMSeg/work_dirs/phase2_r5_eva02_vitb_mask2former'
