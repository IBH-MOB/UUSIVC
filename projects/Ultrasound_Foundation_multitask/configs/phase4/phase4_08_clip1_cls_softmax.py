    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='phase4_08_clip1_cls_softmax',
                tags=['phase4', 'classification', 'softmax', 'clip-1.0']))])
