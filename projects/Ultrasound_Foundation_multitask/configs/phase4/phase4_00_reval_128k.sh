...
CONFIG="$ROOT/projects/Ultrasound_Foundation_multitask/configs/phase4/phase4_00_reval_128k.py"
CHECKPOINT="$ROOT/work_dirs/phase2_r2_dinov2_vitb_mask2former_batch16/iter_128000.pth"
WORK_DIR="$ROOT/work_dirs/phase4_00_reval_128k"
